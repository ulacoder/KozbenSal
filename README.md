...
1. **Калибровка** (при первом запуске):
   ...
   - Смотри на каждую точку по очереди
   - Калибровка пройдет автоматически когда соберется достаточно данных
...
3. **Начать рисовать**:
   - Перемести взгляд на место где хочешь рисовать
   - **Задержи взгляд на 1.5 секунды** - вокруг курсора появится зеленое кольцо
   - Когда кольцо заполнится, начнется рисование
   - Курсор станет красным - двигай глазами чтобы рисовать линию

4. **Остановить рисование**:
   - Снова задержи взгляд на 1.5 секунды
   - Курсор вернется в режим ожидания (белый)

5. **Полезные функции**:
   - `U` - отменить последний штрих если ошибся
